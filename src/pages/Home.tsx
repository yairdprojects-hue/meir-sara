...
export default function Home() {
  const features = [
    ...
    {
      title: 'שבת חתן ושבתות גיבוש',
      description:
        'מתאים לשבתות חתן ושבתות גיבוש. חתן וכלה יכולים להתארגן לפני האירוע, להשאיר חפצים וללון בנוחות גם אחרי החתונה.',
        ...
        <div className="relative z-10 mx-auto min-w-0 max-w-7xl px-4 text-right text-white sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mb-10 ms-auto max-w-2xl text-lg text-stone-200 md:text-xl">
              חדרי שינה, מטבחים, אולם וחצר — הכול מוכן לשבתות חתן ושבתות גיבוש. לינה עד 26 אנשים,
          ...
          <div className="flex flex-col items-center gap-16 lg:flex-row">
            ...
            <div className="w-full min-w-0 text-right lg:w-1/2">
              ...
              <p className="mb-8 text-lg leading-relaxed text-stone-600">
                ...
                שמתאימה לעד כ־100 אורחים לאירוח בחוץ. חתן וכלה מוזמנים להתארגן לפני האירוע, להשאיר חפצים וללון בנוחות גם אחרי החתונה. המתחם בשדרות ירושלים
                106, נתיבות.
              </p>
